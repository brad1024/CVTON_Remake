...
class OASIS_Simple(nn.Module):
    ...
    def forward(self, I_m, C_t, bottom, C_t_mask, body_seg, cloth_seg, densepose_seg, agnostic=None, human_parsing=None):
        ...
        z = torch.cat((I_m, C_t, bottom, C_transformed, C_mask_transformed), dim=1)
